...
EPOCHS = 1
siamese_model = model2.siamese_model_creation()
...
train(model2.train_data, EPOCHS)
# Saves trained model in project folder
siamese_model.save('siamese_model3.h5')
siamese_model.save_weights('siamese_model2_weights.h5')
